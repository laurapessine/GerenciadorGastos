...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdicionar.setOnClickListener(view -> {
            if (txtGasto.getText().toString().isEmpty() || txtValor.getText().toString().isEmpty()) {
                Toast.makeText(getApplicationContext(), "Nome ou valor não informado!", Toast.LENGTH_LONG).show();
            } else {
